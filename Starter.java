...
public class Starter {
	...
	private static String nameOFDifferent;
	...
	public static void main(String[] args) {
		for (int s = 0; s < 4; s++){
			for (int i = 1; i < 7; i++){
				...
				additionName = "no.28 is " + differentAgent;
				nameOFDifferent = additionName;
	...
	//		allNew();
		...
		/**/		finishAnytime();
		 	...
		 	printTheDifferent(nameOFDifferent,nameOFPrint);
...
//				System.out.println("HEY, NEW AGENT: " + a.getIdAgent() + " first variable: " +var);
	...
	private static void restoreAll (double differ){
